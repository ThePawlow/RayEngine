...
public class Engine
{
    public static Window Window = new(new Vector2(1240, 800));
    public static readonly IList<Scene> Scenes = new List<Scene>();
    
    public static readonly float DEG2RAD = MathF.PI / 180.0f;
    // public readonly  float RAD2DEG = 180.0f / MathF.PI;
    public static readonly Uri Resources = new(AppContext.BaseDirectory + "resources");
    public static readonly bool IsResourceFolderValid = Directory.Exists(Resources.LocalPath);
